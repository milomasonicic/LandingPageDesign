...
function LandingPage() {
  ...
  const height = useTransform(scrollYProgress, [0, 0.3], ["25%", "100vh"]);
  ...
  const scaleY = useTransform(scrollYProgress, [0, 0.9], [0.5, 1]); // Povećava se pri skrolovanju
